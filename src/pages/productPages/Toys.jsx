...
const Toys = () => {
    ...
    const products = useLoadData('toy', currentPage);

    return (
        <div className="space-y-10">
            <Helmet>
                <title>TrixMart | Toy</title>
            </Helmet>
            <div className="flex flex-col lg:flex-row justify-between items-center">
                <div className="lg:w-1/2">
                    <h1 className="text-3xl font-normal">Our Exclusive Toys Collections</h1>
                    <p>Spark imagination and joy with our wide range of toys. From educational kits to fun games, we offer engaging options for children of all ages to explore, learn, and play.</p>
                </div>
                <div className="lg:w-1/2">
